...
vignette: >
  ...
  %\VignetteIndexEntry{5. Apply prosail hybrid inversion imaging spectroscopy}
...
The full tutorial including spectral diversity mapping with the `biodivMapR` 
package is available [here](https://jbferet.github.io/biodivMapR/articles/biodivMapR_05.html).

Please visit the main [biodivMapR webpage](https://jbferet.github.io/biodivMapR)
...
url <- "https://gitlab.com/jbferet/myshareddata/-/raw/master/prosail_vignette_illustrations/05_rgb_hyspex.png"
...
```{r, eval=TRUE, echo = FALSE, out.width="100%"}
url <- "https://gitlab.com/jbferet/myshareddata/-/raw/master/prosail_vignette_illustrations/05_bp_prosail.png"
knitr::include_graphics(url)
```
